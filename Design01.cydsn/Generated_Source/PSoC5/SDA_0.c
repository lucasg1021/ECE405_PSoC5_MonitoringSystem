...
*
* \funcusage
*  \snippet SDA_0_SUT.c usage_SDA_0_Write
*******************************************************************************/
...
*
* \funcusage
*  \snippet SDA_0_SUT.c usage_SDA_0_SetDriveMode
*******************************************************************************/
...
*
* \funcusage
*  \snippet SDA_0_SUT.c usage_SDA_0_Read  
*******************************************************************************/
...
* preferred SDA_0_Read() API because the 
* SDA_0_ReadDataReg() reads the data register instead of the status 
...
*
* \funcusage
*  \snippet SDA_0_SUT.c usage_SDA_0_ReadDataReg 
*******************************************************************************/
...
/* If interrupt is connected for this Pins component */ 
    ...
    /*******************************************************************************
    * Function Name: SDA_0_SetInterruptMode
    ****************************************************************************//**
    *
    ...
    *  component. Or you may use SDA_0_INTR_ALL to configure the
    *  interrupt mode of all the pins in the Pins component.       
    *  - SDA_0_0_INTR       (First pin in the list)
    *  - SDA_0_1_INTR       (Second pin in the list)
    *  - ...
    *  - SDA_0_INTR_ALL     (All pins in Pins component)
    *
    * \param mode
    ...
    *
    * \funcusage
    *  \snippet SDA_0_SUT.c usage_SDA_0_SetInterruptMode
    *******************************************************************************/
    void SDA_0_SetInterruptMode(uint16 position, uint16 mode)
    {
		if((position & SDA_0_0_INTR) != 0u) 
		{ 
			 SDA_0_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *
    * \funcusage
    *  \snippet SDA_0_SUT.c usage_SDA_0_ClearInterrupt
    *******************************************************************************/
