...
*
* \funcusage
*  \snippet ESP_RST_SUT.c usage_ESP_RST_Write
*******************************************************************************/
...
*
* \funcusage
*  \snippet ESP_RST_SUT.c usage_ESP_RST_SetDriveMode
*******************************************************************************/
...
*
* \funcusage
*  \snippet ESP_RST_SUT.c usage_ESP_RST_Read  
*******************************************************************************/
...
* preferred ESP_RST_Read() API because the 
* ESP_RST_ReadDataReg() reads the data register instead of the status 
...
*
* \funcusage
*  \snippet ESP_RST_SUT.c usage_ESP_RST_ReadDataReg 
*******************************************************************************/
...
/* If interrupt is connected for this Pins component */ 
    ...
    /*******************************************************************************
    * Function Name: ESP_RST_SetInterruptMode
    ****************************************************************************//**
    *
    ...
    *  component. Or you may use ESP_RST_INTR_ALL to configure the
    *  interrupt mode of all the pins in the Pins component.       
    *  - ESP_RST_0_INTR       (First pin in the list)
    *  - ESP_RST_1_INTR       (Second pin in the list)
    *  - ...
    *  - ESP_RST_INTR_ALL     (All pins in Pins component)
    *
    * \param mode
    ...
    *
    * \funcusage
    *  \snippet ESP_RST_SUT.c usage_ESP_RST_SetInterruptMode
    *******************************************************************************/
    void ESP_RST_SetInterruptMode(uint16 position, uint16 mode)
    {
		if((position & ESP_RST_0_INTR) != 0u) 
		{ 
			 ESP_RST_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *
    * \funcusage
    *  \snippet ESP_RST_SUT.c usage_ESP_RST_ClearInterrupt
    *******************************************************************************/
